...
class PublishersControllerTest < ActionController::TestCase
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post :create, publisher: { city: @publisher.city, name: @publisher.name, publisher_id: @publisher.publisher_id }
    end
  ...
  test "should update publisher" do
    patch :update, id: @publisher, publisher: { city: @publisher.city, name: @publisher.name, publisher_id: @publisher.publisher_id }
    assert_redirected_to publisher_path(assigns(:publisher))
  end
