...
class CopiesControllerTest < ActionController::TestCase
  ...
  test "should create copy" do
    assert_difference('Copy.count') do
      post :create, copy: { available: @copy.available, book_id: @copy.book_id, copy_seq_id: @copy.copy_seq_id, serial_number: @copy.serial_number }
    end
  ...
  test "should update copy" do
    patch :update, id: @copy, copy: { available: @copy.available, book_id: @copy.book_id, copy_seq_id: @copy.copy_seq_id, serial_number: @copy.serial_number }
    assert_redirected_to copy_path(assigns(:copy))
  end
